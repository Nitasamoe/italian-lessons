...
| Infinitive   | German          | Participio Passato | Future Stem |
|--------------|-----------------|--------------------|-------------|
| essere       | sein            | stato              | sar-        |
| avere        | haben           | avuto              | avr-        |
| andare       | gehen           | andato             | andr-       |
| fare         | machen/tun      | fatto              | far-        |
| stare        | sein/bleiben    | stato              | star-       |
| bere         | trinken         | bevuto             | berr-       |
| vedere       | sehen           | visto              | vedr-       |
| parlare      | sprechen        | parlato            | parler-     |
| mangiare     | essen           | mangiato           | manger-     |
| dormire      | schlafen        | dormito            | dormir-     |
| scrivere     | schreiben       | scritto            | scriver-    |
| leggere      | lesen           | letto              | legger-     |
| lavorare     | arbeiten        | lavorato           | lavorer-    |
| studiare     | studieren       | studiato           | studier-    |
| abitare      | wohnen          | abitato            | abiter-     |
| comprare     | kaufen          | comprato           | comprer-    |
| cucinare     | kochen          | cucinato           | cuciner-    |
| giocare      | spielen         | giocato            | giocher-    |
| ascoltare    | zuhören         | ascoltato          | ascolter-   |
| capire       | verstehen       | capito             | capir-      |
| mettere      | setzen/stellen  | messo              | metter-     |
| prendere     | nehmen          | preso              | prender-    |
| lasciare     | lassen          | lasciato           | lascer-     |
| trovare      | finden          | trovato            | trover-     |
| sentire      | fühlen/hören    | sentito            | sentir-     |
| credere      | glauben         | creduto            | creder-     |
| pensare      | denken          | pensato            | penser-     |
| guardare     | schauen         | guardato           | guarder-    |
| entrare      | eintreten       | entrato            | entrer-     |
| partire      | abfahren        | partito            | partir-     |
| arrivare     | ankommen        | arrivato           | arriver-    |
| conoscere    | kennen          | conosciuto         | conoscer-   |
| chiedere     | fragen          | chiesto            | chieder-    |
| rispondere   | antworten       | risposto           | risponder-  |
| aprire       | öffnen          | aperto             | aprir-      |
| chiudere     | schließen       | chiuso             | chiuder-    |
| correre      | rennen          | corso              | correr-     |
| spingere     | schieben        | spinto             | spinger-    |
| tirare       | ziehen          | tirato             | tirer-      |
| usare        | benutzen        | usato              | user-       |
| portare      | tragen/bringen  | portato            | porter-     |
| pagare       | bezahlen        | pagato             | pagher-     |
| perdere      | verlieren       | perso              | perder-     |
| seguire      | folgen          | seguito            | seguir-     |
| decidere     | entscheiden     | deciso             | decider-    |
| offrire      | anbieten        | offerto            | offrir-     |
| incontrare   | treffen         | incontrato         | incontrer-  |
| diventare    | werden          | diventato          | diventer-   |
| succedere    | passieren       | successo           | succeder-   |
| sembrare     | scheinen        | sembrato           | sembrer-    |
| ricordare    | erinnern        | ricordato          | ricorder-   |
| dimenticare  | vergessen       | dimenticato        | dimenticher-|
| aspettare    | warten          | aspettato          | aspetter-   |
| provare      | versuchen       | provato            | prover-     |
| cercare      | suchen          | cercato            | cercher-    |
| mandare      | schicken        | mandato            | mander-     |
| chiamare     | rufen/anrufen   | chiamato           | chiamer-    |

## Reflexive Verbs

| Infinitive       | German            | Participio Passato | Future Stem    |
|------------------|-------------------|--------------------|----------------|
| svegliarsi       | aufwachen         | svegliato          | sveglier-      |
| alzarsi          | aufstehen         | alzato             | alzer-         |
| lavarsi          | sich waschen      | lavato             | laver-         |
| farsi la doccia  | duschen           | fatto              | far-           |
| pettinarsi       | sich kämmen       | pettinato          | pettiner-      |
| truccarsi        | sich schminken    | truccato           | truccher-      |
| radersi          | sich rasieren     | rasato             | rader-         |
| vestirsi         | sich anziehen     | vestito            | vestir-        |
| mettersi         | sich anziehen     | messo              | metter-        |
| sentirsi         | sich fühlen       | sentito            | sentir-        |
| riposarsi        | sich ausruhen     | riposato           | riposer-       |
| rilassarsi       | sich entspannen   | rilassato          | rilasser-      |
| spogliarsi       | sich ausziehen    | spogliato          | spoglier-      |
| addormentarsi    | einschlafen       | addormentato       | addormenter-   |
| coricarsi        | sich hinlegen     | coricato           | coricher-      |
...
| anche            | auch                            |
| però             | jedoch / aber                   |
| tuttavia         | jedoch / dennoch                |
| quindi           | also / deshalb                  |
| allora           | also / dann                     |
| perciò           | deshalb / darum                 |
| infatti          | tatsächlich / in der Tat        |

### Subordinating — Time & Condition
| Italian          | German                          |
|------------------|---------------------------------|
| quando           | wenn / als                      |
| finché           | solange                         |
...
### Subordinating — Cause & Purpose
| Italian          | German                          |
|------------------|---------------------------------|
| perché           | weil / damit                    |
| poiché           | da / weil                       |
| siccome          | da / weil                       |
| affinché         | damit / sodass                  |

### Subordinating — Contrast & Concession
| Italian          | German                          |
|------------------|---------------------------------|
| anche se         | auch wenn / obwohl              |
| benché           | obwohl                          |
| sebbene          | obwohl                          |
| nonostante (che) | obwohl / trotz der Tatsache     |

### Subordinating — Result & Consequence
| Italian          | German                          |
|------------------|---------------------------------|
| così che         | sodass                          |
| tanto che        | so sehr dass                    |
...
- Capisco italiano abbastanza bene, ma non posso ancora parlarlo fluentemente
- Lei ha tutto ciò di cui ha bisogno per cominciare.
- Vogliamo vivere in un posto dove le persone rispettano la natura
- Devi restare calma anche quando cose diventano difficile
- Compro dei libri ogni volte che visito questo negozio
- Vede degli amici dell'università ogni fine settimana
- Scrive delle email prima di cominciare a lavorare
- Si veste delle gonne bellissime in estate
- Sente dei rumore strani di notte in questa casa
- Siamo venuti a visitarti perché ci sei mancato
- Non ho potuto trovare questo libro da nessuna parte
- Ha voluto cambiare il suo professione per molto tempo
- Abbiamo dovuto andare via presto a causa della pioggia
- Vorremo riposare dopo un viaggio così lungo
- Dovrai imparare a stare calma sotto pressione
- Ti dirà tutto quando il momento sarà giusto
- Non posso vedere le montagne, ma qualche volte le vedo
- Bevo il caffe e poi lo bevo di nuovo dopo pranzo
- Non mi dice niente
- La vedo, ma lei non mi vede
- Gli diamo le chiavi ogni mattina
- Lo da a me, ma non a te
- Ci portano il caffè ogni giorno
